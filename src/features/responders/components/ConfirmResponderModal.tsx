...
const ConfirmResponderModal: React.FC<Props> = ({
  type,
  responderName,
  onConfirm,
  onClose,
  ...
  const message = isDelete
    ? `Do you want to delete ${responderName} permanently?`
    : `Are you sure you want to ${type} ${responderName}?`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={CloseIcon} alt="Close" className="h-6 w-6 hover:opacity-50" />
        </button>
...
export default ConfirmResponderModal;