...
interface EditAdminSuccessModalProps {
  onClose: () => void;
  firstName: string;
  lastName: string;
  role: string;
...
const EditAdminSuccessModal: React.FC<EditAdminSuccessModalProps> = ({
  onClose,
  firstName,
  lastName,
  role,
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col ml-20">
          <div className="flex">
            <p className="text-[#0C0E5D] font-bold">Admin Updated Successfully</p>
          ...
          <div className="flex">
            ...
            <div className="flex flex-col">
              <p className="text-[#0C0E5D] font-bold mb-3">
                Full name:{" "}
              ...
              <p className="text-[#0C0E5D] font-bold">
                Role: <span className="text-[#000000] font-extralight">{role}</span>
              </p>
            </div>
          </div>
        </div>
...
export default EditAdminSuccessModal;