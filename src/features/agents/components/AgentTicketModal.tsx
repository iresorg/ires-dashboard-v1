...
const AgentTicketModal: React.FC<AgentTicketModalProps> = ({ ticket, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50" aria-modal="true" role="dialog">
      ...
      >
        ...
        <div>
            <p className="bg-[#EBEBEB] w-40 pl-4 py-2 pr-10 rounded-bl-lg rounded-br-lg text-sm text-[#0C0E5D]">Ticket Details</p>
        </div>
        ...
        <div className="bg-[#F8F3F3]/54  h-35 pt-10 border-dashed border-1 !border-[#616161]/37  rounded-lg">
            ...
            <div>
                <input
                    ...
                    <label htmlFor="fileUpload" className="flex w-58 bg-[#ffffff] ml-40 pr-0 pl-3 rounded-lg ">
                        <img src = {Upload} className="mr-5 "></img>
        ...
        <div>
            <div className="flex  bg-[#0C0E5D]/15 pl-3 pt-1 pb-2 rounded-md">
                <img src={File2} className="mr-5"></img>
                <div className="mr-77">
                    <div>
                ...
                <img src={Trash} className="h-7 w-5 pt-2"></img>
            </div>
            <div className="flex  bg-[#0C0E5D]/15 pl-3 pt-1 pb-2 rounded-md mt-3">
                <img src={Image2} className="mr-5"></img>
                <div className="mr-75">
                    <div>
        ...
        <div className="ml-95 mt-10 mb-5 w-40">
            <button className="bg-[#0C0E5D] text-[#ffffff] px-8 rounded-tl-3xl rounded-br-3xl text-sm font-bold">Create Ticket</button>
        </div>
